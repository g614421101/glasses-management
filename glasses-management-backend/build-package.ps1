...
Write-Host "[2/5] Copying frontend resources to MySQL backend static dir..." -ForegroundColor Cyan
...
Write-Host ''
Write-Host 'Success! MySQL native installer build complete.' -ForegroundColor Green
Write-Host 'The installer (.exe) is located in: glasses-management-backend\dist-install\' -ForegroundColor Green
