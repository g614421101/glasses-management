...
@SpringBootTest(properties = {
        "spring.datasource.url=jdbc:sqlite:file:admin_init_it?mode=memory&cache=shared&date_class=text&date_string_format=yyyy-MM-dd HH:mm:ss.SSS&busy_timeout=5000",
